    ...
    >
      <nav className="w-full px-6 lg:px-12 xl:px-16 relative flex items-center justify-between h-24">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link
            to="/shop"
            className="hidden md:inline-flex px-8 py-3.5 bg-near-black text-white font-semibold text-base border-2 border-near-black hover:bg-white hover:text-near-black hover:-translate-y-0.5 hover:shadow-lg transition-all duration-200"
          >
            {t('nav.getEnergized')}
          </Link>
