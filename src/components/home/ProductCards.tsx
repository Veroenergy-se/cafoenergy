        ...
        <div className="grid md:grid-cols-3 gap-8">
          {products.map((product, i) => (
            <AnimatedSection key={product.id} delay={i * 0.15} direction="scale">
              <div className="group relative bg-white p-12 border border-near-black/5 hover:border-gold/20 hover:shadow-xl hover:shadow-gold/5 hover:-translate-y-1 transition-all duration-300">
                {product.badge && (
                ...
                {/* Product visual */}
                <div className="h-64 bg-gradient-to-br from-cream to-dark-cream flex items-center justify-center mb-8 group-hover:scale-[1.02] transition-transform duration-300">
