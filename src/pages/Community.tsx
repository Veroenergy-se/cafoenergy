    ...
    <>
      ...
      <section className="bg-cream">
        <div className="grid sm:grid-cols-2">
          ...
          >
            <img src="/images/community-padel.jpg" alt="Padel" className="absolute inset-0 w-full h-full object-cover object-top scale-[0.85] origin-top" />
          </SlidePanel>
      ...
      <section className="bg-cream pb-48 sm:pb-64">
        <div className="grid sm:grid-cols-2">
          ...
          >
            <img src="/images/community-frontflip.jpg" alt="Frontflip" className="absolute inset-0 w-full h-full object-cover object-center scale-[0.65] origin-center" />
          </SlidePanel>
